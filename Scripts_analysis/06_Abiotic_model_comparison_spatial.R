...
suppoRt::save_ggplot(plot = ggplot_abiotic_nnd, 
                     filename = "ggplot_abiotic_nnd.png",
...
suppoRt::save_ggplot(plot = ggplot_abiotic_pcf, 
                     filename = "ggplot_abiotic_pcf.png", 
                     path = "Figures/Abiotic_model/", 
                     dpi = 300, width = 15, height = 12.5, units = "cm", 
                     overwrite = overwrite)
...
suppoRt::save_ggplot(plot = ggplot_abiotic_kmm, 
                     filename = "ggplot_abiotic_kmm.png", 
                     path = "Figures/Abiotic_model/", 
                     dpi = 300, width = 15, height = 12.5, units = "cm", 
                     overwrite = overwrite)
...
ci_1999 <- spatstat::subset.ppp(pattern_1999, select = dbh_99) %>% 
  ...
  as.matrix() %>% 
  rabmp:::rcpp_calculate_ci(alpha = parameters_fitted_abiotic$ci_alpha,
                            beta = parameters_fitted_abiotic$ci_beta,
                            max_dist = parameters_fitted_abiotic$ci_max_dist) %>% 
...
ggplot_abiotic_ci <- ggplot(data = ci_overall) + 
...
suppoRt::save_ggplot(plot = ggplot_abiotic_ci, 
                     filename = "ggplot_abiotic_ci.png", 
                     path = "Figures/Abiotic_model/", 
                     dpi = 300, width = 15, height = 12.5, units = "cm", 
                     overwrite = overwrite)
